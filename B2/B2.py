...
class B2:
    ...
    def create_model(self):
        ...
        self.model.add(Conv2D(filters=160, kernel_size=(5, 5), input_shape=self.input_shape, padding="same",
    ...
    def fit_tune(self):
        ...
        tuner_search = RandomSearch(self.tune_model,
                                    ...
                                    max_trials=5, directory='tests/kerastuner_out', project_name="task_B2")

        tuner_search.search(self.X_train, self.Y_train, epochs=5, validation_data=(self.X_val, self.Y_val))

        model=tuner_search.get_best_models(num_models=1)[0]

        model.fit(self.X_train, self.Y_train, epochs=25, validation_split=0.1, initial_epoch=5)
