...
class B1:
    ...
    def create_model(self):
        ...
        self.model.add(Conv2D(filters=224, kernel_size=(5, 5), input_shape=self.input_shape, padding="same",
    ...
    def tune_model(self, hp):
        model = keras.Sequential([
            ...
            keras.layers.Dense(
                units=hp.Int('dense_1_units', min_value=32, max_value=516, step=64),
                activation='relu'
            ),
    ...
    def fit_tune(self):
        ...
        tuner_search = RandomSearch(self.tune_model,
                                    ...
                                    max_trials=5, directory='tests/kerastuner_out', project_name="task_B1")
        ...
        model.fit(self.X_train, self.Y_train, shuffle=True, epochs=15,
                  validation_data=(self.X_val, self.Y_val), initial_epoch=5, callback=[es])
